...
class $AssetsImagesAppleNewsGen {
  const $AssetsImagesAppleNewsGen();

  /// File path: assets/images/apple_news/apple_intelligence.webp
  AssetGenImage get appleIntelligence =>
      const AssetGenImage('assets/images/apple_news/apple_intelligence.webp');

  /// File path: assets/images/apple_news/backgrounds_messages.webp
  AssetGenImage get backgroundsMessages =>
      const AssetGenImage('assets/images/apple_news/backgrounds_messages.webp');

  /// File path: assets/images/apple_news/games.webp
  AssetGenImage get games =>
      const AssetGenImage('assets/images/apple_news/games.webp');

  /// List of all assets
  List<AssetGenImage> get values =>
      [appleIntelligence, backgroundsMessages, games];
}
